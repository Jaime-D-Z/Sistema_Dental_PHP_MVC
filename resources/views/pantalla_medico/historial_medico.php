<?php
require_once __DIR__ . '/../../../app/Http/Controllers/DoctorAppointmentHistoryController.php';
...
$controller = new DoctorAppointmentHistoryController();
...
<head>
  <meta charset="UTF-8">
  <title>Historial de Citas - Médico</title>
...
<nav class="navbar navbar-expand-lg topbar px-4 py-2">
  <a class="navbar-brand fw-bold text-primary" href="/resources/views/layouts/medico_index.php">🦷 ODONTOLOGÍA TC - Médico</a>
  <div class="collapse navbar-collapse">
    <div class="navbar-nav">
      <a class="nav-link" href="/resources/views/layouts/medico_index.php">Inicio</a>
      <a class="nav-link" href="/resources/views/citas/medico_index.php">Citas</a>
      <a class="nav-link active" href="/resources/views/historial/medico_historial.php">Historial Citas</a>
      <a class="nav-link" href="/resources/views/calendario/index.php">Calendario</a>
    </div>
  </div>
  <div class="ms-auto">
    <span class="text-success me-3">Doctor: <?= htmlspecialchars($_SESSION['user']['name']) ?></span>
...
<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <a href="/resources/views/layouts/medico_index.php" class="btn btn-outline-secondary">← Volver al menú</a>
    <form method="GET" class="d-flex" style="gap: 10px;">
      ...
      <a href="medico_historial.php" class="btn btn-outline-primary"><i class="bi bi-arrow-clockwise"></i></a>
    </form>
  </div>
