<?php
require_once __DIR__ . '/../../../app/Http/Controllers/PaymentControllerMedico.php';
require_once __DIR__ . '/../../../config/auth.php';

$controller = new PaymentControllerMedico();
...
<nav class="navbar navbar-expand-lg topbar px-4 py-2">
    ...
    <div class="ms-auto">
 <?= htmlspecialchars($_SESSION['user']['name']) ?> - Médico
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <form method="GET" action="pago_medico.php" class="d-flex" style="gap:10px;">
            <input type="text" name="search" class="form-control" placeholder="Buscar por paciente..." value="<?= htmlspecialchars($search) ?>">
            <button class="btn btn-success"><i class="bi bi-search"></i></button>
            <a href="pago_medico.php" class="btn btn-outline-primary"><i class="bi bi-arrow-clockwise"></i></a>
        </form>
    </div>
